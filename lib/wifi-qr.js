...
export function buildWifiPayload({ ssid, password, authType, hidden }) {
    ...
    // Standard format: WIFI:T:<TYPE>;S:<SSID>;P:<PASSWORD>;H:<HIDDEN>;;
    // T:nopass is explicitly included for legacy compatibility.
    let payload = `WIFI:T:${authType};S:${escapedSsid};`;
